    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True,
                                              related_name='Grader', serialize=False, to=settings.AUTH_USER_MODEL)),
                ('name', models.CharField(max_length=250)),
                ('subject_name', models.CharField(max_length=250)),
                ('email', models.EmailField(max_length=254)),
                ('phone', models.IntegerField()),
                ('grader_profile_pic', models.ImageField(blank=True, upload_to='classroom/grader_profile_pic')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grades_obtained', models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grades_obtained', models.CharField(max_length=250)),

                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='marks',
                                              to='classroom.Student')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='given_marks',
        ...
        migrations.AddField(
            ...
            name='grader',
            field=models.ManyToManyField(related_name='grade_assignments', to='classroom.Grader'),
        ),
        migrations.AddField(
            model_name='classassignment',
            name='teacher',
